        ...
        <div class="glass-card p-5 text-center shadow-lg border-0" style="border-radius: 30px;">
            ...
            <div class="bg-light p-4 rounded-4 text-start mb-4 shadow-sm border-0" style="background: rgba(255,255,255,0.5) !important;">
                <div class="d-flex justify-content-between mb-2">
                    ...
                    <span class="fw-bold text-primary"><?php echo e($transaksi->kode_transaksi); ?></span>
                </div>
                <div class="d-flex justify-content-between mb-2">
                    <span class="text-muted">Penerima:</span>
                    <span class="fw-semibold"><?php echo e($transaksi->nama_penerima); ?></span>
                </div>
                <div class="d-flex justify-content-between mb-2">
                ...
                <div class="d-flex justify-content-between mt-2">
                    ...
                    <span class="fw-bold text-danger fs-5">Rp <?php echo e(number_format($transaksi->total_harga, 0, ',', '.')); ?></span>
                </div>
            </div>

            <a href="<?php echo e(route('frontend.katalog')); ?>" class="btn btn-primary btn-lg rounded-pill px-5 fw-bold shadow">Kembali Belanja</a>
        </div>
    </div>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECT RADIT\Toko_online-Laravel\resources\views/frontend/sukses.blade.php ENDPATH**/ ?>