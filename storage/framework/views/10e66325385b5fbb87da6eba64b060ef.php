...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light navbar-floating">
        <div class="container-fluid">
            <a class="navbar-brand fw-bold" href="<?php echo e(route('frontend.home')); ?>">
                <img src="<?php echo e(asset('image/logo.png')); ?>" alt="Toko Online" height="35" onerror="this.outerHTML='<span class=\'fw-bold\'>TOKO ONLINE</span>'">
            </a>
    ...
    <footer class="footer text-center mt-auto">
        <div class="container">
            ...
            <p class="mb-0 text-muted">&copy; <?php echo e(date('Y')); ?> Hak Cipta Dilindungi. Didesain dengan penuh gaya.</p>
        </div>
    </footer>
