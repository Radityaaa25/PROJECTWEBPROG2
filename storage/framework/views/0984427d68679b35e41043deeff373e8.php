...
waves-dark pro-pic" href="" data-toggle="dropdown" aria-haspopup="true" ariaexpanded="false">
                                <?php if(Auth::user()->foto): ?>
                                    <img src="<?php echo e(asset('storage/img-user/' . Auth::user()->foto)); ?>" alt="user"
                                        class="rounded-circle" width="31" onerror="this.src='<?php echo e(asset('image/img-default.jpg')); ?>'">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('image/img-default.jpg')); ?>" alt="user"
            ...
            <div class="scroll-sidebar">
                ...
                waves-dark sidebar-link" href="<?php echo e(route('backend.user.index')); ?>" aria-expanded="false"><i
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href=" <?php echo e(route('backend.transaksi.index')); ?> "
                                aria-expanded="false">
                                <i class="mdi mdi-cart"></i><span class="hide-menu">Transaksi</span>
                            </a>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href=" <?php echo e(route('backend.laporan_penjualan.index')); ?> "
                                aria-expanded="false">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waveseffect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                ...
                                <li class="sidebar-item"><a href="<?php echo e(route('backend.produk.index')); ?>" class="sidebar-link"><i
