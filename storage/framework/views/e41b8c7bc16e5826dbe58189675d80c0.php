...
<div class="p-5 mb-5 glass-card position-relative overflow-hidden">
    ...
    <div class="container-fluid py-5 text-center position-relative" style="z-index: 1;">
        ...
        <a class="btn btn-primary btn-lg rounded-pill px-5 fw-bold" href="<?php echo e(route('frontend.katalog')); ?>" type="button" style="box-shadow: 0 5px 15px rgba(13,110,253,0.3);">Mulai Belanja Sekarang</a>
    </div>
</div>
